    ...
    class Thongtin extends controller{
        ...
        function them(){
            if(isset($_POST['btnThem'])){
                ...
                $sdt=$_POST['txtsdt'];
                $qq=$_POST['txtdc'];
                if(empty($m)|| empty($t)|| empty($ns)|| empty($gt)|| empty($sdt)|| empty($qq)){
                    ...
                    "qq"=>$qq
                      ...
                      if($this->goi->trungma($m)){
                        ...
                        "qq"=>$qq
                           ...
                           $kq=$this->goi->them($m,$t,$gt,$ns,$qq,$sdt);
                              if($kq){
            ...
            if(isset($_POST['btnSua'])){
                ...
                if(empty($m)|| empty($t)|| empty($ns)|| empty($gt)|| empty($sdt)|| empty($qq)){
                    ...
                    $this->view("Masterlayout",["page"=>"suatt","dulieu"=>$this->goi->tim($m)]);
                      ...
                      $kq=$this->goi->sua($m,$t,$gt,$ns,$qq,$sdt);
                if($kq){
                    echo '<script>alert("Sửa thành công!");
                    window.location.href = "http://localhost/quanlysieuthi/Thongtin";</script>';
                }
                else{
